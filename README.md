...
## Si on veut enregistrer l'image en svg on doit executer ce code :
```
import qrcode
...
qr_code = qrcode.QRCode(
    ...
    # il faut savoir que plus le niveau de correction d'erreur est élevé, plus le QR Code est grand et plus il est difficile à scanner et donc il faut prendre leniveau elevé que si on a un QR Code avec beaucoup de données à encoder et
